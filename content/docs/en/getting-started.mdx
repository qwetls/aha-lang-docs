...
- Take the [Language Tour](/en/language-tour) to learn types, operators, and control flow
- Read about [Functions](/en/functions) and [Strings](/en/strings)
- Look under the hood in [Architecture](/en/architecture)