...
Desain ini adalah pintu masuk alami ke gaya fungsional: fungsi yang memetakan input ke output tanpa efek samping tersembunyi. Ini bukan kebetulan — ini keputusan desain yang disengaja, seperti yang bisa dilihat di seluruh [Language Tour](/language-tour).
...
Semua nilai, semua ekspresi — inilah inti dari "Easy to read. Powerful to wield." Jika kamu ingin mendalami bagaimana kompiler mewujudkan filosofi ini, ikuti [Course](/course) kami dari pelajaran pertama.